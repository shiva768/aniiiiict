    ...
    BehaviorSpec({
                ...
                then("trueを返す") {
                    ...
                    val mockResponse =
                        ApolloResponse
                            ...
                            ).data(CreateRecordMutation.Data(createRecord = null))
                            .build()
                    coEvery {
                    ...
                    val mockResponse =
                        ApolloResponse
                            .Builder(
                                operation = CreateRecordMutation(episodeId = episodeId),
                                requestUuid = Uuid(1, 1),
                            ).errors(listOf(Error.Builder(message = "API Error").build()))
                            .build()
                    coEvery {
                        annictApolloClient.executeMutation(
                            any<Mutation<*>>(),
        ...
        given("AnnictRepositoryImpl の handleAuthCallback メソッド") {
            ...
            `when`("認証が失敗した場合") {
                then("falseを返す") {
                    coEvery {
                        authManager.handleAuthorizationCode(code)
                        ...
                        ApolloResponse
                            .Builder(
                                ...
                                ViewerProgramsQuery.Data(
                                    viewer =
                                        ViewerProgramsQuery.Viewer(
                                            programs =
                                                ViewerProgramsQuery.Programs(
                        ...
                        ApolloResponse
                            .Builder(
                                ...
                                ViewerRecordsQuery.Data(
                                    viewer =
                                        ViewerRecordsQuery.Viewer(
                                            records =
                                                ViewerRecordsQuery.Records(
                                                    nodes =
                                                        listOf(
                                                            ViewerRecordsQuery.Node(
                                                                ...
                                                                episode =
                                                                    mockk<ViewerRecordsQuery.Episode>(
                                                                        relaxed = true,
                                                                    ),
                                                            ),
                                                        ),
                    ...
                    val mockResponse =
                        ApolloResponse
                            .Builder(
                                ...
                                requestUuid = Uuid(1, 1),
                            ).data(DeleteRecordMutation.Data(deleteRecord = null))
                            .build()
                    coEvery {
                        annictApolloClient.executeMutation(
                            any<Mutation<*>>(),
                    ...
                    val mockResponse =
                        ApolloResponse
                            .Builder(
                                ...
                                requestUuid = Uuid(1, 1),
                            ).data(UpdateStatusMutation.Data(updateStatus = null))
                            .build()
                    coEvery {
                        annictApolloClient.executeMutation(
                            any<Mutation<*>>(),
