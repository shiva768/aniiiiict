...
// New Stylish Dark Theme based on screenshot
val DarkBrown = Color(0xFF1C1B1F)
val CardBrown = Color(0xFF4A4441) // A bit lighter for cards
val AccentOrange = Color(0xFFD48D60)
val TextWhite = Color(0xFFE6E1E5)

// Keeping light theme colors as a fallback, but the focus is the dark theme.
...
val md_theme_dark_primary = Color(0xFFD48D60) // AccentOrange
val md_theme_dark_onPrimary = Color(0xFFFFFFFF) // TextWhite
val md_theme_dark_primaryContainer = Color(0xFFD48D60) // AccentOrange
val md_theme_dark_onPrimaryContainer = Color(0xFFFFFFFF) // TextWhite
...
val md_theme_dark_background = Color(0xFF1C1B1F) // DarkBrown
val md_theme_dark_onBackground = Color(0xFFE6E1E5) // TextWhite
val md_theme_dark_surface = Color(0xFF1C1B1F) // DarkBrown for general surfaces
val md_theme_dark_onSurface = Color(0xFFE6E1E5) // TextWhite
val md_theme_dark_surfaceVariant = Color(0xFF4A4441) // CardBrown for card backgrounds
val md_theme_dark_onSurfaceVariant = Color(0xFFE6E1E5) // TextWhite
val md_theme_dark_outline = Color(0xFF8D9199)
val md_theme_dark_inverseOnSurface = Color(0xFF1A1C1E)
val md_theme_dark_inverseSurface = Color(0xFFE2E2E6)
val md_theme_dark_inversePrimary = Color(0xFFD48D60)
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFFD48D60)
