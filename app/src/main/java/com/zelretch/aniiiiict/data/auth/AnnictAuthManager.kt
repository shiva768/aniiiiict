...
import com.zelretch.aniiiiict.data.api.AnnictConfig
import com.zelretch.aniiiiict.data.model.TokenResponse
...
class AnnictAuthManager @Inject constructor(
    ...
    companion object {
        private const val REDIRECT_URI = "aniiiiict://oauth/callback"
    ...
    private suspend fun getAccessTokenWithRetry(code: String): TokenResponse {
        val retryConfig = com.zelretch.aniiiiict.util.RetryConfig(
